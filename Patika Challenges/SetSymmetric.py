...
and one set has subscribed to the French newspaper. Your task is to find the total number of students who have subscribed to either the English or the French newspaper but not both.
Input Format
...
setsymm = aset.symmetric_difference(bset)
print(len(setsymm));
"end"
